...
```{r}
rsconnect::setAccountInfo(name='jaquelinegentil',
			  token='564429CE184B7B7589E6A98C6F0D527C',
			  secret='76kAcGdqu0dd1Wdaw9XG9+Ea3u81xGKpORWCuOpP')
...
#nos_completo_abr2021_a_abr2024 <- read_excel("~/dash/nos_completo_abr2021_a_abr2024.xlsx")

# URL do arquivo .xlsx bruto no GitHub
url <- "https://github.com/5141445/rede/raw/main/nos_completo_abr2021_a_abr2024.xlsx"
...
# Ler o arquivo .xlsx
nos_completo_abr2021_a_abr2024 <- read_excel(temp_file)
...
#rede_2_jun2022_a_mai2023 <- read_excel("~/dash/rede_2_jun2022_a_mai2023.xlsx")


# URL do arquivo .xlsx bruto no GitHub
url <- "https://github.com/5141445/rede/raw/main/rede_2_jun2022_a_mai2023.xlsx"
...
# Ler o arquivo .xlsx
rede_2_jun2022_a_mai2023 <- read_excel(temp_file)
...
caminho <- "C:/Users/Jaqueline/Documents/dash"
